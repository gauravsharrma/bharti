function initLanguageSwitcher() {
  ...
  const i18nMap = {
    ...
    heroHeading: {
      en: "Zero commission, trusted guidance, no hassles — just a smart property move, delivered professionally.",
      ar: "بدون عمولة، إرشاد موثوق، بدون متاعب — خطوة عقارية ذكية تُنفذ باحترافية.",
      fr: "Zéro commission, conseils fiables, sans tracas — un choix immobilier intelligent, livré avec professionnalisme.",
      ru: "Без комиссии, надежное руководство, никаких хлопот — разумная сделка с профессиональной подачей.",
      zh: "零佣金，值得信赖的指导，无烦恼 —— 智能置业，专业呈现。",
    },
    heroSubheading: {
